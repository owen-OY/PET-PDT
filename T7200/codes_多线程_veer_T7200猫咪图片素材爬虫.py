...
# @File         : codes_多线程_veer_T7200猫咪图片素材爬虫.py
# @Mark         :
                # 1.合入多线程爬虫代码
...
class GetImg(object):
    ...
    def getDogPicture(self):
        while True:
            urlList = [f'https://www.veer.com/search-image/mao/?sort=best&page={self.num}']
            ...
            logger.add(f'./log/{timeinfo}_codes_多线程_veer_T7200猫咪图片素材爬虫.log', rotation='50MB', encoding='utf-8', enqueue=True)  # 输出控制台中的log文件
