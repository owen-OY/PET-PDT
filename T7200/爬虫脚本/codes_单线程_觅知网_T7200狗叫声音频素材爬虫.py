...
# @File         : codes_单线程_觅知网_T7200狗叫声音频素材爬虫.py
# @Mark         :
                # 1.合入多线程爬虫代码
...
class GetMp3(object):
    def getCatsound(self):
        ...
        logger.add(f'./log/{timeinfo}_codes_单线程_veer_T7200狗叫声音频素材爬虫.log', rotation='50MB', encoding='utf-8',
        ...
        for num in range(1, 11): # 最大页码数加1
            urlList = [f'https://www.51miz.com/so-sound/1764403/p_{num}/']
            soundLinkAfterList1 = []
