...
# @Author       : kintan.wang
# @Date         : 2021/8/6 15:00
# @File         : codes_单线程_波奇网_T7200图片素材爬虫.py
# @Mark         :
                # 1.增加log打印级别以及log文件输出
# @NewestUpdateDate   :2021/9/22  16:20
        ...
        while True:
            ...
            for i in urlList:
                ...
                for j in dogHtmlList:
                    ...
                    logger.add(f'./log/{timeinfo}_codes_单线程_波奇网_T7200图片素材爬虫.log', rotation='50MB', encoding='utf-8',
